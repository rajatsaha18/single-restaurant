                            ...
                            <div class="row">
                                <div class="col-sm-3 col-md-12">
                                    <div class="form-group">
                                        <label for="addon_zip" class="col-form-label"> <?php echo e(trans('labels.zip_file')); ?> </label>
                                        <input type="file" class="form-control" name="addon_zip" id="addon_zip" required="">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group float-end">
                                        <a href="<?php echo e(URL::to('admin/systemaddons')); ?>" class="btn btn-outline-danger"> <?php echo e(trans('labels.cancel')); ?> </a>
...
<?php echo $__env->make('admin.theme.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u120135824/domains/businesssolution.com.bd/public_html/burger/resources/views/admin/systemaddons/createsystem-addons.blade.php ENDPATH**/ ?>