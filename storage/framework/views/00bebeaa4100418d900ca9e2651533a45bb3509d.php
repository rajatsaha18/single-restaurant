                        ...
                        <div class="row mb-4 ">
                            ...
                            <div class="col-xl-12 col-lg-6 col-sm-6 my-1">
                                <div class="card border-0  rounded-3 p-3 h-100">
                                    ...
                                    <h5 class="text-muted"><?php echo e(ucfirst($timedata->day)); ?> <span
                                        class="cursor-pointer" data-bs-toggle="modal"
                                        data-bs-target="#modal_working_hours"><i
                                            class="fa-solid fa-circle-info fs-6 text-dark"></i></span></h5>
                                    <p><?php echo e($timedata->open_time); ?> <b><?php echo e(trans('labels.to')); ?></b> <?php echo e($timedata->break_start); ?></p>
                                    <p><?php echo e($timedata->break_end); ?> <b><?php echo e(trans('labels.to')); ?></b> <?php echo e($timedata->close_time); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('web.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u204847481/domains/aguarestaurant.de/public_html/resources/views/web/contactus.blade.php ENDPATH**/ ?>