...
<?php $__env->startSection('content'); ?>
    ...
    <section class="book-table my-5">
        <div class="reservation-area">
            <div class="container">
                <form class="rounded-5" action="<?php echo e(route('front.table.new')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('web.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u120135824/domains/businesssolution.com.bd/public_html/burger/resources/views/web/reservation.blade.php ENDPATH**/ ?>