            ...
            <div style="width:100%;max-width:500px;background:#ffffff;height:180px">
                ...
                <center>
                    <a href="javascript:void(0)">
                        <img alt="" src='<?php echo e($logo); ?>' width="170" height="170" style="display:block;font-family:Helvetica,Arial,sans-serif;color:#666666;font-size:16px" border="0" class="CToWUd">
                    </a>
                </center>
            </div>
            <br>
                ...
                <div style="width:100%;max-width:580px;background:#ffffff;height:auto;padding:0px 0 0px 0">
                    <div style="font-family:'Lato',Helvetica,Arial,sans-serif;display:inline-block;margin:0px 0px 0 0;max-width:100%;width:100%;margin-right:0px">
                        <div style="width:100%;max-width:580px;background:#ffffff;height:auto;padding:20px 0 0px 0">
                            <div bgcolor="#f8f4e8" align="left" style="padding:0px 0% 0px 0%;font-size:22px;line-height:25px;font-family:'Lato',Helvetica,Arial,sans-serif;color:#19c0c2;font-weight:700" class="m_-7788511936867687679padding-copy"><?php echo e(trans('labels.dear')); ?> <?php echo e($name); ?>,</div>
...
</html><?php /**PATH /home/u913747247/domains/elpasto.de/public_html/resources/views/Email/reservation_response.blade.php ENDPATH**/ ?>