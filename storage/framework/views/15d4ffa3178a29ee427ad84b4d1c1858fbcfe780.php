                    ...
                    <div class="border-0 offcanvas offcanvas-start  nav-sidebar" data-bs-scroll="true" data-bs-backdrop="false" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
                        ...
                        <div class="navbar-collapse collapse">
                            <div class="navbar-nav mx-auto">
                                ...
                                <a class="nav-link px-3 <?php echo e(request()->is('menu.list') ? 'active' : ''); ?>" href="<?php echo e(route('menu.list')); ?> "><?php echo e(trans('menu-list')); ?></a>
...
<?php /**PATH /home/u204847481/domains/aguarestaurant.de/public_html/resources/views/web/layout/header.blade.php ENDPATH**/ ?>