    ...
    <tbody>
        ...
        <?php $__currentLoopData = $topitems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if($item->item_order_counter > 0): ?>
                <tr>
                    <td><img src="<?php echo e(Helper::image_path($item['item_image']->image_name)); ?>" class="rounded hw-50" alt=""></td>
...
<?php /**PATH /home/u204847481/domains/aguarestaurant.de/public_html/resources/views/admin/dashboard/topproducttable.blade.php ENDPATH**/ ?>