...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group">
                                        <label class="col-form-label" for=""><?php echo e(trans('labels.description')); ?> </label>
                                            <textarea name="description" id="summernote" class="form-control" rows="4" placeholder="<?php echo e(trans('labels.description')); ?>"><?php echo e($getslider->description); ?></textarea>
...
<?php echo $__env->make('admin.theme.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp25-09-24\htdocs\burger29-09-24\resources\views/admin/slider/edit.blade.php ENDPATH**/ ?>