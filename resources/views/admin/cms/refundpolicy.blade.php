                ...
                <div class="card border-0">
                    <div class="card-body">
                        <div id="privacy-policy-three" class="privacy-policy">
                            <form action="{{ URL::to('admin/refundpolicy/update') }}" method="post">
                                @csrf
                                <textarea class="form-control" id="ckeditor" name="refundpolicy">{{ @$getrefundpolicy->refundpolicy_content }}</textarea>
                                @error('refundpolicy')
