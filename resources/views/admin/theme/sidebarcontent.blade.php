...
<ul class="navbar-nav">
    ...
    <li class="nav-item mb-2 fs-7 ">
        <a class="nav-link rounded d-flex" href="{{route('video.index')}}" aria-expanded="false">
            <i class="fa-sharp fa-solid fa-list"></i><span class="nav-text ">Video</span>
        </a>
    </li>
    <li class="nav-item mb-2 fs-7 ">
        <a class="nav-link rounded d-flex" href="{{route('videoGallery.index')}}" aria-expanded="false">
    ...
    <li class="nav-item mb-2 fs-7 {{ Auth::user()->type != 1 ? (in_array('15', $modules) == true ? '' : 'd-none') : '' }}" id="15">
        <a class="nav-link rounded d-flex {{ request()->is('admin/bookings*') ? 'active' : '' }}" href="{{ URL::to('/admin/bookings') }}" aria-expanded="false">
            <i class="fa-solid fa-calendar-days"></i><span class="nav-text ">{{ trans('labels.bookings') }} <span class="ml-5 bg-danger text-light" style="border-radius: 50%;padding:5px 10px 5px 10px">{{$count}}</span></span>
        </a>
    </li>
