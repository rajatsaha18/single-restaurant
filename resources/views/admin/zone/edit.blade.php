...
@section('content')
    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
                ...
                <div class="card border-0">
                    <div class="card-body">
                        <div class="form-validation">
                            <form action="{{ URL::to('admin/zone/update-' . $zonedata->id) }}" method="post"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <label class="col-lg-12 col-form-label" for="">{{ trans('labels.name') }}
                                    </label>
                                    <div class="col-lg-12">
                                ...
                                <div class="form-group">
                                    <label class="col-lg-12 col-form-label" for="">{{ trans('labels.delivery_charge') }}
                                    </label>
                                    <div class="col-lg-12">
                                        <input type="text" class="form-control" name="delivery_charge"
                                        oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
                                            value="{{ $zonedata->delivery_charge }}" placeholder="{{ trans('labels.delivery_charge') }}" required>
                                ...
                                <div class="form-group">
                                    <label class="col-lg-12 col-form-label" for="">{{ trans('labels.coordinates') }}
                                    </label>
                                    <div class="col-lg-12">
                                ...
                                <div class="form-group text-end">
                                    <a href="{{URL::to('admin/zone')}}"><button class="btn btn-outline-danger" @if (env('Environment') == 'sendbox') onclick="myFunction()" @endif type="button">{{ trans('labels.cancel') }}</button></a>
            ...
            <div class="col-md-8">
                <div class="card border-0">
                    <div class="card-body p-2 h-450-px">
...
@endsection
@section('script')
<script src="https://maps.googleapis.com/maps/api/js?key={{ @Helper::appdata()->map }}&libraries=drawing,places">
    </script>
<script>
