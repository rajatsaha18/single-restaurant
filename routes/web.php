...
use App\Http\Controllers\front\MenuListController;
use App\Http\Controllers\front\DownloadPdfController;
...
Route::group(['namespace' => 'front', 'middleware' => 'MaintenanceMiddleware'], function () {
	...
	Route::post('/table-new', [WebBookingsController::class, 'store'])->name('front.table.new');
...
Route::group(['prefix' => 'admin', 'namespace' => 'admin'], function () {
	...
	Route::group(['middleware' => 'AdminAuth' ],function(){
        ...
        Route::get('video/add',[VideoController::class,'create'])->name('video.add');
        Route::post('video/new',[VideoController::class,'store'])->name('video.new');
        ...
        Route::post('videoGallery/new', [VideoGalleryController::class,'newVideo'])->name('videoGallery.new');
        Route::get('videoGallery/edit/{id}', [VideoGalleryController::class,'edit'])->name('videoGallery.edit');
        Route::post('videoGallery/update/{id}', [VideoGalleryController::class,'update'])->name('videoGallery.update');
        Route::get('videoGallery/delete/{id}', [VideoGalleryController::class,'delete'])->name('videoGallery.delete');

		// bookings
		Route::get('bookings', [BookingsController::class,'bookings']);
		Route::get('bookings/delete/{id}', [BookingsController::class,'delete'])->name('book.delete');
